...
function M.on_attach(client, buffer)
  ...
  local format = require("reevonr.lspdap.lsp.format").format
  ...
  self:map("<leader>lw", require("reevonr.lspdap.lsp.utils").toggle_diagnostics, { desc = "Toggle Inline Diagnostics" })
end
